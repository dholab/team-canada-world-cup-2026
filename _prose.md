...
The final four air samples that were being collected on July 4 (when Team Canada was eliminated from the tournament) were used for metagenomic sequencing with Illumina VSP2 target-capture, allowing us to detect additional human respiratory and environmental viruses across the sampled hotel spaces (Figure 3). In agreement with the Genexpert data showing SARS-CoV-2 genetic material in the Houston hotel earlier in tSARS-CoV-2 was recovered from the meal room air sample collected on July 4, as well as from an equipment-room sample. Sequencing additionally recovered respiratory viruses not targeted by the Cepheid assay, human coronavirus OC43 and rhinovirus, alongside ubiquitous commensal viruses such as Merkel cell polyomavirus that are detected in nearly all sequences from human-occupied congregate spaces. No viral detections were obtained from the extraction blank or the no-template controls.
